...
common_package(vmmlib 1.7.0  QUIET)
if(NOT vmmlib_FOUND AND NOT VMMLIB_FOUND)
  set(FIND_REQUIRED_FAILED "${FIND_REQUIRED_FAILED} vmmlib")
endif()
common_package(HDF5 1.8 COMPONENTS C HL QUIET)
if(NOT HDF5_FOUND AND NOT HDF5_FOUND)
  set(FIND_REQUIRED_FAILED "${FIND_REQUIRED_FAILED} HDF5")
endif()
common_package(Boost 1.41.0 COMPONENTS program_options QUIET)
if(NOT Boost_FOUND AND NOT BOOST_FOUND)
  set(FIND_REQUIRED_FAILED "${FIND_REQUIRED_FAILED} Boost")
endif()
common_package(CUDA   QUIET)
if(NOT CUDA_FOUND AND NOT CUDA_FOUND)
  set(FIND_REQUIRED_FAILED "${FIND_REQUIRED_FAILED} CUDA")
endif()
