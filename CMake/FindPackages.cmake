...
common_package(vmmlib 1.7.0  REQUIRED )
common_package(HDF5 1.8  REQUIRED COMPONENTS C HL)
common_package(Boost 1.41.0  REQUIRED COMPONENTS program_options)
common_package(CUDA   REQUIRED )
...
if(vmmlib_name)
  list(APPEND FIND_PACKAGES_DEFINES IV_USE_VMMLIB)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND IV_DEPENDENT_LIBRARIES vmmlib)
  endif()
...
if(HDF5_name)
  list(APPEND FIND_PACKAGES_DEFINES IV_USE_HDF5)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND IV_DEPENDENT_LIBRARIES HDF5)
  endif()
...
if(Boost_name)
  list(APPEND FIND_PACKAGES_DEFINES IV_USE_BOOST)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND IV_DEPENDENT_LIBRARIES Boost)
  endif()
...
if(CUDA_name)
  list(APPEND FIND_PACKAGES_DEFINES IV_USE_CUDA)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND IV_DEPENDENT_LIBRARIES CUDA)
  endif()
  set(FIND_PACKAGES_FOUND "${FIND_PACKAGES_FOUND} CUDA")
  link_directories(${${CUDA_name}_LIBRARY_DIRS})
  if(NOT "${${CUDA_name}_INCLUDE_DIRS}" MATCHES "-NOTFOUND")
    include_directories(${${CUDA_name}_INCLUDE_DIRS})
  endif()
endif()
...
if(libzmq_name)
  list(APPEND FIND_PACKAGES_DEFINES IV_USE_LIBZMQ)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND IV_DEPENDENT_LIBRARIES libzmq)
  endif()
...
if(OpenGL_name)
  list(APPEND FIND_PACKAGES_DEFINES IV_USE_OPENGL)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND IV_DEPENDENT_LIBRARIES OpenGL)
  endif()
...
set(IV_BUILD_DEBS autoconf;automake;cmake;doxygen;git;git-review;libzmq3-dev;pkg-config;subversion)

set(IV_DEPENDS vmmlib;HDF5;Boost;CUDA;libzmq;OpenGL)
